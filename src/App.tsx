...
const fallbackState: ControlCenterState = {
  ...
  apps: [
    ...
    app('venice-media-local', 'Venice Media', 'venice-media-local', 'Local Venice API media workspace for images, video, music, voice, and cleanup.', '#34c6a3', 'VM', releasedToolsCategory),
