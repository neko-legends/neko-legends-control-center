...
fn default_apps() -> Vec<LauncherApp> {
    vec![
        ...
        app("sprite-atlas-packer", "Sprite Atlas Packer", "sprite-atlas-packer", "Turn loose sprite frames into deterministic TexturePacker-compatible PNG/WebP atlases.", "#39a7ff", "SA", "-= Released Work Stuff =-", ToolStatus::Available, None),
