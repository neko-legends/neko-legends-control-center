...
fn default_apps() -> Vec<LauncherApp> {
    vec![
        ...
        app("multi-angle-edit", "Multi-Angle Edit", "MultiAngleEdit", "Local multi-angle image editor: re-render a photo from a new camera angle with Qwen-Image-Edit + the Multiple-Angles LoRA on your own GPU.", "#b14bff", "MA", RELEASED_WORK_STUFF_CATEGORY, ToolStatus::Available, None),
