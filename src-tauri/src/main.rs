...
fn normalize_categories(categories: Vec<String>) -> Vec<String> {
    ...
    for category in categories {
        let label = clean_category_label(&category);
...
fn default_apps() -> Vec<LauncherApp> {
    vec![
        ...
        app("depth-map-ai-generator", "DepthMap AI", "depth-map-generator", "Batch depth-map and WebP generator for local AI image workflows.", "#43b883", "DM", UNDER_DEVELOPMENT_CATEGORY, ToolStatus::ComingSoon, None),
        ...
        app("venice-media-local", "Venice Media", "venice-media-local", "Local Venice API media workspace for images, video, music, voice, and cleanup.", "#34c6a3", "VM", RELEASED_TOOLS_CATEGORY, ToolStatus::Available, None),
